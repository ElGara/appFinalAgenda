...
function creaNuevaDB(tx){
	...
	tx.executeSql("INSERT INTO agenda_curso (id,nombre,apellidos,telefono,categoria,foto,email,nota, pweb) VALUES (1,'Mónica','Olivarría','+6699900970','Familia','','m.olivarria@ccumazatlan.mx','Buena maestra','www.google.com')");
}
